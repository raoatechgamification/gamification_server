...
class CertificateController {
  ...
  async editCertificate(req: Request, res: Response) {
    try {
      ...
      certificate.authorizedSignature1Name =
        authorizedSignature1Name || certificate.authorizedSignature1Name;
      certificate.authorizedSignature1Title =
        authorizedSignature1Title || certificate.authorizedSignature1Title;
      certificate.authorizedSignature2 = Urls[1];
      certificate.logo1 = Urls[2];
      certificate.logo2 = Urls[3];
      certificate.authorizedSignature2Name =
        authorizedSignature2Name || certificate.authorizedSignature2Name;
      certificate.authorizedSignature2Title =
        authorizedSignature2Title || certificate.authorizedSignature2Title;
